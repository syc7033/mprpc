...
class RpcHeader :
 ...
 public:
  ...
  // uint32 agrs_size = 3;
  void clear_agrs_size();
  ::PROTOBUF_NAMESPACE_ID::uint32 agrs_size() const;
  void set_agrs_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_agrs_size() const;
  void _internal_set_agrs_size(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 agrs_size_;
...
// uint32 agrs_size = 3;
inline void RpcHeader::clear_agrs_size() {
  agrs_size_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_agrs_size() const {
  return agrs_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::agrs_size() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.agrs_size)
  return _internal_agrs_size();
}
inline void RpcHeader::_internal_set_agrs_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  agrs_size_ = value;
}
inline void RpcHeader::set_agrs_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_agrs_size(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.agrs_size)
}
